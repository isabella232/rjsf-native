...
const ArrayFieldTemplate = (props: ArrayFieldTemplateProps) => {
	...
	if (isMultiSelect(registry?.schemaUtils.validator, schema, registry?.definitions)) {
...
const AddButton = (props: { onPress: (event: any) => void; disabled?: boolean }) => {
...
const DefaultFixedArrayFieldTemplate = (props: ArrayFieldTemplateProps) => {
	return (
		<View style={styles.container}>
			...
			<View style={styles.content}>{props.items && props.items.map(DefaultArrayItem)}</View>

			{props.canAdd && (
				<AddButton disabled={props.disabled || props.readonly} onPress={props.onAddClick} />
			)}
		</View>
	);
};
